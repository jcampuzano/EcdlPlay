...
abstract class BaseEcdlPreguntaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dificultad' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'imagen_id'  => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('EcdlImagen'), 'required' => false)),
      'dificultad' => new sfValidatorInteger(array('required' => false)),
